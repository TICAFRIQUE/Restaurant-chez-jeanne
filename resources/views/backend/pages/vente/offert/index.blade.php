...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            //                 // utiliser un swal pour afficher le nombre d'offerts non approuvés
            //                 Swal.fire({
            //                     position: 'center',
            //                     icon: 'warning',
            ...
            //             console.log('Offerts non approuvés:', offerts);


            //             // Ajouter les nouveaux offerts au tableau
